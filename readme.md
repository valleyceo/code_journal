...
|   |-- b. Best Substring - Longest Balanced Substring (Algo).py
|   `-- b. Best Substring - Smallest Substring Containing (Algo).py
|-- 2. Array
...
|   |-- a. 1D - Stack - Next Greater Element (Algo).py
|   |-- a. 1D - Stack - Shorten Path (Algo).py
...
|   |-- 3_Word_Ladder.cpp
|   |-- b. Graph Search - A Star (Algo).py
|   |-- b. Graph Search - Bellman Ford - Detect Arbitrage (Algo).py
|   |-- b. Graph Search - Bridges in Graph - Two-Edge-Connected Graph (Algo).py
|   `-- b. Graph Search 2 - DFS - Airport Connectinos (Algo).py
|-- 9. Design
|   |-- 1_Min_Stack.cpp
